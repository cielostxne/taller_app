...
<section class="breadcrumb is-right has-bullet-separator" aria-label="breadcrumbs">
    <ul>
        ...
        <div class="columns is-centered is-multiline">
            ...
            <div class="column is-5">
                <div class="box">
                    ...
                    <a class="button is-link mt-2" href="<?= URL_PATH ?>/page/deportes">Leer más</a>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="columns is-multiline">
            ...
            <div class="box is-one-quarter">
                ...
                <a class="is-link is-size-7" href="<?= URL_PATH ?>/page/deportes">Leer más</a>
            </div>
            ...
            <div class="box is-one-quarter">
                ...
                <a class="is-link is-size-7" href="<?= URL_PATH ?>/page/negocios">Leer más</a>
            </div>
            ...
            <div class="box is-one-quarter">
                ...
                <a class="is-link is-size-7" href="<?= URL_PATH ?>/page/noticias">Leer más</a>
            </div>
